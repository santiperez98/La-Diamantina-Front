...
const productsData = [
  
  {
    ...
    image: img11,
    options: [
      { size: '30x7x5 cm', color: 'Gris', price: 20.15 },
      { size: '30x7x5 cm', color: 'Amarilla', price: 36.50 },
      { size: '25x7x5 cm', color: 'Gris', price: 17.20 },
      { size: '25x7x5 cm', color: 'Amarilla', price: 29.20 },
      { size: '20x7x5 cm', color: 'Gris', price: 14.15 },
      { size: '20x7x5 cm', color: 'Amarilla', price: 17.75 },
    ],
  },

  {
    ...
    image: img4,
    options: [
      { size: '30x5x5 cm', color: 'Gris', price: 16.80 },
      { size: '25x5x5 cm', color: 'Amarilla', price: 18.00 },
      { size: '25x5x5 cm', color: 'Gris', price: 14.40 },
      { size: '20x5x5 cm', color: 'Amarilla', price: 14.40 },
      { size: '20x5x5 cm', color: 'Gris', price: 12.00 },
    ],
  },
  {
    name: 'Doble Faz',
    image: img12,
    options: [
      { size: '22x4x5 cm',  price: 18.50 },
      { size: '20x4x5 cm',  price: 16.60 },
      { size: '18x4x5 cm',  price: 13.60 },
      { size: '16x4x5 cm',  price: 11.65 },
    ],
  },
  {
    name: 'Hogar',
    image: img2,
    options: [
      { size: '20x3x5 cm', price: 9.00 },
      { size: '18x3x5 cm', price: 7.80 },
      { size: '16x3x5 cm', price: 7.20 },
      { size: '15x3x5 cm', price: 6.60 },
      { size: '14x3x5 cm', price: 6.00 },
      { size: '12x3x5 cm', price: 5.40 },
    ],
  },
  {
    name: 'Petit Hogar',
    image: img1,
    options: [
      { size: '20x2,5x5 cm', price: 7.20 },
      { size: '18x2,5x5 cm', price: 6.60 },
      { size: '16x2,5x5 cm', price: 6.00 },
      { size: '14x2,5x5 cm', price: 5.40 },
    ],
  },
  {
    ...
    image: img3,
    options: [
      { size: '18 cm largo', price: 9.00 },
      { size: '16 cm largo', price: 7.80 },
      { size: '14 cm largo', price: 7.20 },
      { size: '12 cm largo', price: 6.00 },
    ],
  },
  ...
  
  {
    ...
    image: img8,
    options: [
      { size: '20 cm espesor 5 cm', price: 90.00 },
      { size: '19 cm espesor 5 cm', price: 84.00 },
      { size: '18 cm espesor 5 cm', price: 78.00 },
      { size: '16 cm espesor 5 cm', price: 66.00 },
    ],
  },
  {
    name: 'Guadañas',
  ...
  },
  {
    ...
    image: img5,
    options: [
      { size: '5x5x3 cm', price: 1.20 },
      { size: '5x7x5 cm', price: 2.60 },
    ],
  },
];
